...
var sumNumbers = a+b;
arr[0] = sumNumbers;
arr[1] = 'The sum of '+a+' and '+b+' is '+sumNumbers+'.';
return arr;
}
...
function multiply(a, b) { //eslint-disable-line
    var arr = [];
    var mutiplyNumbers = a*b;
    console.log('The sum of '+a+' and '+b+' is '+mutiplyNumbers+'.');
arr[0] = mutiplyNumbers;
arr[1] = 'The product of '+a+' and '+b+' is '+mutiplyNumbers+'.';
return arr;
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    arr[0] = sumNum;
    arr[1] = multiplyNum;
    arr[2] = a+' and '+b+' and '+c+' sum to '+sumNum+'.';
    arr[3] = 'The product of '+a+' and '+b+' and '+c+' is '+multiplyNum+'.';
    return arr;
}
